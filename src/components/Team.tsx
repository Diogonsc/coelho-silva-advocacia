  ...
  const team = [
    {
      ...
      image: lawyer1,
      description:
        "Especialista em direito penal com mais de 10 anos de experiência em casos complexos de crimes contra a pessoa e patrimônio.",
    ...
    },
    {
      ...
      image: lawyer3,
      description:
        "Advogado especializado em direito penal e processo penal, com vasta experiência em defesa de clientes em casos de alta complexidade.",
      ...
      achievements: [
        "300+ casos defendidos",
        "95% de sucesso",
        "Especialista em medidas cautelares",
      ],
      contact: {
        phone: "(21) 99999-9998",
    ...
    },
    {
      ...
      image: lawyer4,
      description:
        "Advogado criminalista com mais de 15 anos de experiência, especializado em casos de alta complexidade e recursos para tribunais superiores.",
      ...
      achievements: [
        "1000+ casos defendidos",
        "99% de sucesso",
        "Especialista em STJ e STF",
      ],
      contact: {
        phone: "(21) 99999-9997",
    ...
    },
    {
      ...
      image: lawyer5,
      description:
        "Advogado criminalista com mais de 10 anos de experiência, especializado em casos de alta complexidade e recursos para tribunais superiores.",
      education: "Universidade de São Paulo",
      experience: "10+ anos",
      specializations: [
        "Recursos Criminais",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 md:mb-16 animate-fade-in">
            ...
            <p className="text-base md:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto text-balance leading-relaxed px-4 md:px-0">
              Conheça os advogados especialistas que formam nossa equipe e estão
            ...
            >
              <CarouselContent className="-ml-1 md:-ml-4">
                {team.map((member, index) => (
                  ...
                  >
                    <Card className="card-elegant p-2 md:p-6 h-full hover-lift group border border-border/90">
                      {/* Member Image */}
                        ...
                        <div className="space-y-1 md:space-y-2">
                          ...
                          {member.achievements.length > 2 && (
                            <div className="flex items-center gap-2 text-sm md:text-base">
                              <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-primary rounded-full flex-shrink-0"></div>
                              <span className="text-muted-foreground">
                                +{member.achievements.length - 2} mais
                              </span>
                            </div>
                          )}
                        </div>
          ...
          {/* CTA Section */}
          <div
            className="text-center mt-12 md:mt-16 animate-fade-in"
          ...
          >
            <div className="bg-gradient-to-r from-primary/5 via-trust/5 to-primary/5 border border-primary/20 rounded-2xl p-6 md:p-8 lg:p-12 max-w-4xl mx-auto">
              ...
              <p className="text-base md:text-lg text-muted-foreground mb-6 md:mb-8 max-w-2xl mx-auto">
                Nossa equipe está pronta para atender você. Agende sua consulta
                gratuita e conheça como podemos ajudar.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  onClick={() =>
                    window.open(
                      "https://wa.me/5521998055549?text=Olá, gostaria de agendar uma consulta com a equipe.",
                      "_blank"
                    )
                  }
